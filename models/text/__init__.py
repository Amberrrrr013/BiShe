...
class AIGenerateProvider(TextProvider):
    ...
    def _map_difficulty(self, difficulty: str) -> str:
        ...
        mapping = {
            "easy": "elementary",
            "intermediate": "college_cet",
            "advanced": "english_major"
        }
    ...
    def _build_prompt(self, topic: str, length: int, difficulty: str, style: str) -> str:
        ...
        difficulty_desc = {
            ...
            "college_cet": """大学四六级水平英语演讲 - 适合四六级考生或相当水平学习者。词汇达四六级5000-6000词。句子20-30词，复杂句超50%。能用各种从句和虚拟语气、倒装句、强调句型等高级语法。可探讨教育公平职业规划，科技伦理等思辨性议题。风格逻辑清晰、论证深入，用词精准。适合演讲比赛或学术研讨会。""",
